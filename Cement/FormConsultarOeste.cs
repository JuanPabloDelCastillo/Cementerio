...
namespace Cement
{
    public partial class FormConsultarOeste : Form
    {
        ...
        {
            Consulta_Oeste objOeste = new Consulta_Oeste();
            objOeste.dgvCausante.DataSource = this.objCausante.MostrarCausantesOeste();
            this.Close();
        }
