...
{
    public partial class _00001_Inhuma : Form
    {
        ...
        public _00001_Inhuma(Causante paramCausante)
        {
            InitializeComponent();
        ...
        public void cargarCodigoCem()
        {
            try
            {
                ...
                this.cmbCodCem.DataSource = objNomencOeste.MostrarTodos();//usando la clase nomenc
        ...
        private void _00001_Inhuma_Load(object sender, EventArgs e)
        {
            DesactivaTxt();
        }

        private void cmbCodCem_Leave(object sender, EventArgs e)
        {
        ...
        {
            this.Close();
            _00002_Causante dbcau = new _00002_Causante();
            dbcau.btnModificar.Enabled = false;
         }


        //private void cmbTipoConst_Leave(object sender, EventArgs e)
        //{
        //    txtSeccion.Enabled = true;
        //    txtZona.Enabled = true;
        //    txtCuadro.Enabled = true;
        ...
        //private void cmbTipoConst_KeyUp(object sender, KeyEventArgs e)
        //{
        //    txtSeccion.Enabled = true;
        //    txtZona.Enabled = true;
        //    txtCuadro.Enabled = true;
        ...
        //private void cmbTipoConst_Layout(object sender, LayoutEventArgs e)
        //{
        //    txtSeccion.Enabled = true;
        //    txtZona.Enabled = true;
        //    txtCuadro.Enabled = true;
