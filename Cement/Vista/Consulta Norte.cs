...
{
    public partial class Consulta_Norte : Form
    {
        public Consulta_Norte()
        {
            InitializeComponent();
            txtBusqueda.Clear();
            cargarCodigoCem();
        ...
        private void Consulta_Norte_Load(object sender, EventArgs e)
        {
            this.dgvCausante.DataSource = this.objCausante.MostrarCausantesNorte();
        ...
        private void btnConsultar_Click_1(object sender, EventArgs e)
        {
            ...
            {
                FormConsultarNorte objForm = new FormConsultarNorte(this.objCausante);//enviar como parametro un nuevo causante 
