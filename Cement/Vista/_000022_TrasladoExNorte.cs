...
namespace Cement.Vista
{
    public partial class _000022_TrasladoExNorte : Form
    {
        ...
        private void _000022_TrasladoExNorte_Load(object sender, EventArgs e)
        {
        ...
        public void cargarConst_Tipo(int id_Nomenc)
            ...
            public void cargarCodigoCem()
            {
                try
                {
                    ...
                    this.cmbCodCem.DataSource = objNomencN.MostrarReporte();
        ...
        private void txtNicho_Numero_TextChanged(object sender, EventArgs e)
        {
            try
            {
                BindingSource objBindingSource = new BindingSource();
                objBindingSource.DataSource = this.dgvCausante.DataSource;
                objBindingSource.Filter = "NumeroNicho = '" + this.txtNicho_Numero.Text + "' AND TamanoNichoT LIKE '%" + this.txtTamNicho.Text + "%' AND GaleriaN LIKE '%" + this.txtGaleria.Text + "%'";
                this.dgvCausante.DataSource = objBindingSource.DataSource;
            }
            catch (Exception ex)
            {
        ...
        private void btnEditar_Click_1(object sender, EventArgs e)
        {
            ...
            {
                _00012_Traslado_ExternoNorte objForm = new _00012_Traslado_ExternoNorte(this.objCausante);//enviar como parametro un nuevo causante 
        ...
        private void btnTrasladar_Click_1(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(this.objCausante.ToString()))
            {
                _00012_Traslado_ExternoNorte objForm = new _00012_Traslado_ExternoNorte(this.objCausante);//enviar como parametro un nuevo causante al constructor de la clase.
