...
{
    public partial class _00017_Traslado_InternoNorte : Form
    {
        public _00017_Traslado_InternoNorte()
        {
            InitializeComponent();
            txtBusqueda.Clear();
            cargarCodCemInt();
        ...
        private void _00017_Traslado_InternoNorte_Load(object sender, EventArgs e)
        {
        ...
        public void cargarCodCemInt()
        {
            try
            {
                Nomenc objNomencNorte = new Nomenc();
                objNomencNorte.CodNomenc = 2;
                this.cmbCodCemInt.ValueMember = "id_Nomenc";
                this.cmbCodCemInt.DisplayMember = "Codcem";
                this.cmbCodCemInt.DataSource = objNomencNorte.MostrarTodos();//usando la clase nomenc
        ...
        private void btnTrasladar_Click(object sender, EventArgs e)
        {
            ...
            {
                _00018_Traslado_Interno_Norte objForm = new _00018_Traslado_Interno_Norte(this.objCausante);
                    //_00018_Traslado_Interno_Norte(this.objCausante);//enviar como parametro un nuevo causante al constructor de la clase.
                objForm.Text = "TRASLADO INTERNO NORTE";
        ...
        private void cmbCodCemInt_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            try
            {
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(this.objCausante.ToString()))
            {
                _00018_Traslado_Interno_Norte objForm = new _00018_Traslado_Interno_Norte(this.objCausante);//enviar como parametro un nuevo causante 

                objForm.Text = "CONSULTA NORTE";
                objForm.cmbCodCem.Enabled = false;
                objForm.btnNuevoCement.Enabled = false;
                objForm.cmbTipoConst.Enabled = false;
