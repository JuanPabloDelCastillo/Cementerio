...
{
    public partial class _00018_Traslado_Interno_Oeste : Form
    {
        ...
        public _00018_Traslado_Interno_Oeste(Causante paramCausante)
        {
            InitializeComponent();
        ...
        public _00018_Traslado_Interno_Oeste()
        {
        }
        ...
        private void _00018_Traslado_Interno_Load(object sender, EventArgs e)
        {
            cargarTramiteInt();
