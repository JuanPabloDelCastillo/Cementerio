...
{
    public partial class _00018_Traslado_Interno_Norte : Form
    {
        ...
        public _00018_Traslado_Interno_Norte(Causante paramCausante)
        {
            InitializeComponent();
        ...
        public _00018_Traslado_Interno_Norte()
        {
        ...
        public void cargarCodigoCem()
        {
            try
            {
                ...
                //this.cmbCodCem.DataSource = objNomencNorte.MostrarTodos();//usando la clase nomenc
                this.cmbCodCem.ValueMember = "id_Nomenc";
                this.cmbCodCem.DisplayMember = "Codcem";
        ...
        private void cmbCemInt_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            cargarConst_TipoInt((int)this.cmbCemInt.SelectedValue);
            ActivarDesactivarControlesInt();
        }

        private void cmbTipoConstInt_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            ActivarDesactivarControlesInt();
        }
