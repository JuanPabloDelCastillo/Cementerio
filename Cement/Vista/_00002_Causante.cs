...
{
    public partial class _00002_Causante : Form
    {

        public _00002_Causante()
        {
            InitializeComponent();
            txtBusqueda.Clear();
            cargarCodigoCem();
            ...
            this.cmbCodCem.SelectedIndex = -1;
        ...
        private void _00002_Causante_Load(object sender, EventArgs e)
        {
        ...
        public void cargarCodigoCem()
        {
            try
            {
                ...
                objNomenc.CodNomenc = 1;
                this.cmbCodCem.ValueMember = "id_Nomenc";
                this.cmbCodCem.DisplayMember = "Codcem";
                this.cmbCodCem.DataSource = objNomenc.MostrarTodos();//usando la clase nomenc
                this.cmbCodCem.SelectedIndex = -1;
        ...
        private void btnNuevo_Click(object sender, EventArgs e)
        {
            ...
            _00001_Inhuma objForm = new _00001_Inhuma(new Causante());//enviar como parametro un nuevo causante
        ...
        private void btnModificar_Click(object sender, EventArgs e)
        {
            ...
            {
                _00001_Inhuma objForm = new _00001_Inhuma(this.objCausante);//enviar como parametro un nuevo causante al constructor de la clase.
        ...
        private void cmbCodCem_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            //    this.btnModificar.Enabled = false;
            //    //this.cmbCodCem.SelectedIndex = -1;
            //    //dgvCausante.CurrentRow.Cells["ColumnCodcem"].
            //}
            //else
            //{
            //    this.txtCuadro.Clear();
        ...
        {
            //if (dgvCausante.CurrentRow.Cells["ColumnCodcem"].Value.ToString() == "NORTE")
            //{
            //    MessageBox.Show("La Selección elegida no es correcta", "Error de validación", MessageBoxButtons.OK, MessageBoxIcon.Error);
            //    btnModificar.Enabled = false;
            //    txtCuadro.Clear();
            //    txtZona.Clear();
            //    txtLote.Clear();
            ...
            //if (dgvCausante.CurrentRow.Cells["ColumnCodcem"].Value.ToString() == "JARDIN")
            //{
            //    MessageBox.Show("La Selección elegida no es correcta", "Error de validación", MessageBoxButtons.OK, MessageBoxIcon.Error);
            //    //e.Cancel = true;
            //    btnModificar.Enabled = false;
