...
namespace Entidades
{
    public class NomencNorte
    {
        #region"Constructor"
        public NomencNorte()//el constructor siempre tiene el mismo nombre que la clase.
            : base()
        {
        ...
        {
            return new AccesoDatos.AccesoDatos().EjecutarProcedimientosConsultas("Usp_Cementerio_NomencNorte_Seleccionar", OpcionSeleccionar, this.id_Nomenc);
        }
        ...
        {
            return new AccesoDatos.AccesoDatos().EjecutarProcedimientoInsertarActualizarEliminar("Usp_Cementerio_NomencNorte_InsertarActualizarEliminar", OpcionMantenimiento,
