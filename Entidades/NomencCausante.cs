...
namespace Entidades
{
    public class NomencCausante
    {
        #region"Constructor"
        public NomencCausante()//el constructor siempre tiene el mismo nombre que la clase.
            : base()
        {
        ...
        {
            return new AccesoDatos.AccesoDatos().EjecutarProcedimientosConsultas("Usp_Cementerio_NomencCausante_Seleccionar", OpcionSeleccionar, this.id_Nomenc, this.Dni);
        }
        ...
        {
            return new AccesoDatos.AccesoDatos().EjecutarProcedimientoInsertarActualizarEliminar("Usp_Cementerio_NomencCausante_InsertarActualizarEliminar", OpcionMantenimiento,
